...
<div id="tab-live" class="tab-page h-full overflow-y-auto no-scrollbar px-4 pb-28 space-y-3.5">
      <div id="wildSummonCard" class="holo-wild-card st3-glow-bg p-3.5 flex items-center justify-between cursor-pointer active:scale-98 transition shadow-sm" style="position:relative;z-index:0;">
        ...
        <button type="button" id="btnSummonWildBadge" onclick="event.stopPropagation();handleGenerateWildNPC();" class="flex items-center gap-1 bg-white/80 backdrop-blur-md px-2.5 py-1 rounded-full border border-white text-rose-600 text-[10px] font-black shadow-sm" style="position:relative;z-index:2;font-family:inherit;">
      ...
      <!-- 【停机维护 · 官方通告横幅】开播概率 = 0% 且全平台无人直播时，出现在核心频道条下方；
           有一位主播自主开播就自动收起。显隐见 updateMaintenanceBanner() -->
      <div id="liveMaintBanner" class="maint-notice hidden">
        <div class="flex items-center gap-3">
          <span class="maint-emblem">
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 2 4 5.5v6c0 4.6 3.4 8.6 8 10 4.6-1.4 8-5.4 8-10v-6L12 2z"></path><path d="m9 12 2 2 4-4"></path></svg>
          </span>
          <div class="flex-1 min-w-0">
            <div class="flex items-center gap-2">
              <span class="maint-title">正在维护中…</span>
              <span class="maint-seal">LUMA LIVE 官方运营组</span>
            </div>
            <p class="maint-desc">平台正在进行系统维护升级，推荐与开播排期服务暂停；主播仍可照常开播。</p>
          </div>
          <span class="maint-chip on flex-shrink-0"><i class="maint-dot"></i>维护中</span>
        </div>
