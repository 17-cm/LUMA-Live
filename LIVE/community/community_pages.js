...
<div id="communityTrendsView" class="full-page-view hidden">
    ...
    <div class="cat-rail" id="hotCatRail">
      <button class="cat-chip on">实时</button>
      <button class="cat-chip">娱乐</button>
      <button class="cat-chip">科技</button>
      <button class="cat-chip">体育</button>
      <button class="cat-chip">游戏</button>
      <button class="cat-chip">音乐</button>
      <button class="cat-chip">影视</button>
    </div>
    <div id="flow">
