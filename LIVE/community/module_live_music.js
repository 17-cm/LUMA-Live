    ...
    box.innerHTML =
      ...
      '<div class="relative overflow-hidden rounded-3xl p-5 mb-4 bg-white border border-slate-100 shadow-sm">' +
        ...
        '<div class="flex items-center justify-between mt-3">' +
          ...
          '<button class="px-3 h-7 rounded-full bg-slate-900 text-white text-[10px] font-black tracking-wider active:scale-95 transition">浏览全部</button>' +
        '</div>' +
      '</div>' +
      ...
      // 空态：居中
      '<div class="flex flex-col items-center justify-center py-16 px-6 rounded-3xl bg-white border-2 border-dashed border-slate-200">' +
        '<div class="w-16 h-16 rounded-full bg-gradient-to-br from-fuchsia-100 to-blue-100 flex items-center justify-center mb-3">' +
          '<svg class="w-7 h-7 text-slate-700" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round">' +
            '<path d="M9 18V5l12-2v13"></path><circle cx="6" cy="18" r="3"></circle><circle cx="18" cy="16" r="3"></circle>' +
          '</svg>' +
        '</div>' +
        '<p class="text-sm font-black text-slate-900">还没有歌单</p>' +
        '<p class="text-[11px] text-slate-500 mt-1.5 text-center leading-relaxed">点击右上角 <span class="inline-flex items-center justify-center w-4 h-4 rounded-full bg-gradient-to-br from-fuchsia-500 to-pink-500 text-white align-middle"><svg class="w-2.5 h-2.5" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3.5" stroke-linecap="round"><line x1="12" y1="5" x2="12" y2="19"></line><line x1="5" y1="12" x2="19" y2="12"></line></svg></span> 创建你的第一个歌单<br/>直播间就能循环播放啦</p>' +
