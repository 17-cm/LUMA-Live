        ...
        <div class="accordion-item" id="accItemOpsPoll">
          <div class="accordion-header" onclick="toggleAccordion('accItemOpsPoll')">
            <div class="flex items-center gap-3">
              ...
              <h4 class="text-xs font-black text-slate-900">直播判定间隔</h4>
            </div>
            <div class="flex items-center gap-2">
          ...
          <div class="accordion-body space-y-2">
            ...
            <div class="flex justify-between items-center mb-1">
              <span class="text-[11px] font-bold text-slate-700">主播判定间隔</span>
              <span id="valOpsPollInterval" class="text-purple-600 font-bold">3 分钟</span>
            </div>
            <p class="text-[9px] text-slate-400 mb-1.5">同一个主播隔多久允许掷一次开播/下播骰。倾向值就是在这个间隔上被判定的：数值越高分越大，但命中落在哪一拍完全没准——所以每场播多久、每次歇多久都是活的。间隔越短判定越勤、节奏越快。</p>
